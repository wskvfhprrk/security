package com.hejz.security.core.authentication.mobile;
...
public class SmsCodeAuthenticationFilter extends
    ...
    public static final String SPRING_SECURITY_FORM_MODEL_KEY = "mobile";

    private String mobileParameter = SPRING_SECURITY_FORM_MODEL_KEY;
    //只处理post请求
